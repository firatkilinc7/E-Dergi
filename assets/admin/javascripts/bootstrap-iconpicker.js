...
;(function($){ "use strict";
    ...
    Iconpicker.ICONSET = {
        ...
        medicon: $.iconset_medicon || Iconpicker.ICONSET_EMPTY,
    ...
    Iconpicker.DEFAULTS = {
        ...
        labelFooter: 'Toplam : {2} / {0} - {1} arası',
        placement: 'bottom',
        rows: 3,
        search: true,
        searchText: 'İkon Arayın',
    ...
    Iconpicker.prototype.updateSearch = function () {
        ...
        var search = [
            '<tr>',
            '   <td colspan="' + op.cols + '">',
            '       <input type="text" class="form-control search-control" style="width: ' + op.cols * 64 + 'px;" placeholder="' + op.searchText + '">',
            '   </td>',
            '</tr>'
        ];
        search = $(search.join(''));
